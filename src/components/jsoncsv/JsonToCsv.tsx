...
import { jsonToCsv } from "@/lib/converterJsonCsv";
import {
  ArrowRight,
  Clipboard,
  ClipboardCheck,
...
export default function JsonToCsv() {
  ...
  const handleConvert = useCallback(() => {
    if (!input.trim()) {
      setError("Masukkan data JSON untuk dikonversi.");
      return;
    }
    ...
    setTimeout(() => {
      const result = jsonToCsv(input, { delimiter, includeHeaders, quoteAll });
  ...
  }, [input, delimiter, includeHeaders, quoteAll]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-4 rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900">
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <Label htmlFor="headers-json" className="cursor-pointer text-sm">
            Headers
          </Label>
        </div>
        ...
        <div className="flex items-center gap-2">
          <Switch
            id="quoteall-json"
            checked={quoteAll}
            onCheckedChange={setQuoteAll}
          />
          <Label htmlFor="quoteall-json" className="cursor-pointer text-sm">
            Quote All Fields
          </Label>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-3">
          ...
          <CodeEditor
            ...
            language="csv"
            readOnly
            placeholder="CSV yang dikonversi akan muncul di sini..."
            minRows={18}
          />
      ...
      <div className="flex justify-center">
        ...
        >
          ...
          {isConverting ? "Mengkonversi..." : "Konversi JSON → CSV"}
